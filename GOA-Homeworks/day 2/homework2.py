...
# "sandro" არის ცვლადის მნიშვნელობა
...
age= 13 #ეს არის int (integer) მთელი რიცხვიheight = 143 #ეს არის float ტიპის ცვლადი (ათწილადი)
...
isUgly= False #ჯავასკრიპტული camlcase
